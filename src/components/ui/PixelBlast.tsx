  ...
  useEffect(() => {
    ...
    if (mustReinit) {
      ...
      const setSize = () => {
        ...
        // Ignore small vertical changes (address bar on mobile)
        const widthChanged = w !== lastWidth;
        const heightChanged = Math.abs(h - lastHeight) > 50; // Threshold for height change
      ...
      const animate = () => {
        ...
        if (composer) {
          ...
          composer.passes.forEach(p => {
            ...
            if (effs && typeof effs.forEach === 'function') {
